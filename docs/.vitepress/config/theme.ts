...
export const themeConfig: DefaultTheme.Config = {
  ...
  footerConfig: {
    ...
    icpRecordCode: '黔ICP备2023014830号-1', // ICP备案号
    publicSecurityRecordCode: '黔公网安备12011202300677号', // 联网备案号
    copyright: `Copyright © 2023-${new Date().getFullYear()} Lewis` // 版权信息
  }
}